        ...
        <div className="flex justify-end items-center gap-3 mb-3">
          {session ? (
            <div className="flex items-center gap-3 bg-white/80 backdrop-blur px-4 py-2 rounded-full shadow">
              <a href="/pricing" className="px-4 py-1.5 bg-pink-100 text-pink-600 rounded-full text-sm font-bold hover:bg-pink-200 transition">💎 定价</a>
              <a href="/profile" className="px-4 py-1.5 bg-pink-100 text-pink-600 rounded-full text-sm font-bold hover:bg-pink-200 transition">👤 个人中心</a>
            ...
            <div className="flex items-center gap-3">
              <a href="/pricing" className="px-4 py-2 bg-white/80 text-pink-600 rounded-full text-sm font-bold hover:bg-white transition">💎 定价</a>
